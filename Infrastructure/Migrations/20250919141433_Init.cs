    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    PublicCode = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    FullName = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    PersonalPhoneNumber = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    ParentPhoneNumber = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    SubscriptionStatus = table.Column<int>(type: "int", nullable: false),
                    CurrentGradeId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    CurrentGroupId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "GroupTransferHistories",
                columns: table => new
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    StudentId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    FromGroupId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ToGroupId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    TransferDate = table.Column<DateOnly>(type: "date", nullable: false),
                    Reason = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupTransferHistories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GroupTransferHistories_Groups_FromGroupId",
                        column: x => x.FromGroupId,
                        principalTable: "Groups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_GroupTransferHistories_Groups_ToGroupId",
                        column: x => x.ToGroupId,
                        principalTable: "Groups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_GroupTransferHistories_Students_StudentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudentExamScores_Exams_ExamId",
                        column: x => x.ExamId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupTransferHistories_FromGroupId",
                table: "GroupTransferHistories",
                column: "FromGroupId");

            migrationBuilder.CreateIndex(
                name: "IX_GroupTransferHistories_StudentId",
                table: "GroupTransferHistories",
                column: "StudentId");

            migrationBuilder.CreateIndex(
                name: "IX_GroupTransferHistories_ToGroupId",
                table: "GroupTransferHistories",
                column: "ToGroupId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentExamScores_ExamId",
